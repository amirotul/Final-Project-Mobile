...
import com.example.aplikasimeme.Model.ModelData;
import com.example.aplikasimeme.R;
import com.example.aplikasimeme.RegisterActivity;
        ...
        public  HolderData (View view)
        {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent update = new Intent(context, RegisterActivity.class);
